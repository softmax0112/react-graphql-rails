...
# source://graphiql-rails-1.8.0/lib/graphiql/rails/config.rb:1
module GraphiQL; end

# source://graphiql-rails-1.8.0/lib/graphiql/rails/config.rb:2
module GraphiQL::Rails
  class << self
    # Returns the value of attribute config.
    #
    # source://graphiql-rails-1.8.0/lib/graphiql/rails.rb:21
    def config; end
...
# source://graphiql-rails-1.8.0/lib/graphiql/rails/config.rb:3
class GraphiQL::Rails::Config
  # @return [Config] a new instance of Config
  #
  # source://graphiql-rails-1.8.0/lib/graphiql/rails/config.rb:20
  ...
  #
  # source://graphiql-rails-1.8.0/lib/graphiql/rails/config.rb:10
  def csrf; end
  ...
  #
  # source://graphiql-rails-1.8.0/lib/graphiql/rails/config.rb:8
  def headers; end
  ...
  #
  # source://graphiql-rails-1.8.0/lib/graphiql/rails/config.rb:30
...
# source://graphiql-rails-1.8.0/lib/graphiql/rails/config.rb:16
GraphiQL::Rails::Config::CSRF_TOKEN_HEADER = T.let(T.unsafe(nil), Hash)

# source://graphiql-rails-1.8.0/lib/graphiql/rails/config.rb:12
GraphiQL::Rails::Config::DEFAULT_HEADERS = T.let(T.unsafe(nil), Hash)

# source://graphiql-rails-1.8.0/app/controllers/graphiql/rails/editors_controller.rb:3
class GraphiQL::Rails::EditorsController < ::ActionController::Base
  # source://graphiql-rails-1.8.0/app/controllers/graphiql/rails/editors_controller.rb:8
  def graphql_endpoint_path; end

  # source://graphiql-rails-1.8.0/app/controllers/graphiql/rails/editors_controller.rb:4
  def show; end
...
# source://graphiql-rails-1.8.0/app/controllers/graphiql/rails/editors_controller.rb:0
module GraphiQL::Rails::EditorsController::HelperMethods
  include ::ActionController::Base::HelperMethods

  # source://graphiql-rails-1.8.0/app/controllers/graphiql/rails/editors_controller.rb:7
  def graphql_endpoint_path(*args, &block); end
end

# source://graphiql-rails-1.8.0/lib/graphiql/rails/engine.rb:3
class GraphiQL::Rails::Engine < ::Rails::Engine; end

# source://graphiql-rails-1.8.0/lib/graphiql/rails/version.rb:3
